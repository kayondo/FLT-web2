...
<div class="bg-pattern h-64 -mb-16 border-b border-gray-3">
    <div class="container pt-32">
        <h1 class="heading-2">News & Events</h1>
    </div>
</div>

<div class="container flex pb-16 flex-wrap">
    <?php
    while (have_posts())
    {
        the_post();
    ...
    <article class="w-full md:w-2/3 md:pr-6">
        <figure class="h-image w-full rounded-xl">
    ...
    <div class="w-full md:w-1/3 md:pl-6 hidden md:block">
        <article class="w-full rounded-xl shadow bg-white hover:shadow-lg ">
            <a href="<?php echo $prev_post->guid ?>">
                ...
                <p class="mt-auto p-5 pt-0 text-gray-500"><?php echo get_the_date('F j, Y',$prev_post->ID ); ?></p>
            </a>
            </article>
    </div>
